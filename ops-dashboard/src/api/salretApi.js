...
export const getMonthInsight = (monthKey) => request(`/api/months/${encodeURIComponent(monthKey)}/insight`);
export const regenerateMonthInsight = (monthKey) =>
  request(`/api/months/${encodeURIComponent(monthKey)}/insight/regenerate`, { method: "POST" });
